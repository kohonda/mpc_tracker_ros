...
class ZeroHorizonOCP final : public OptimalControlProblem
{
    ...
    // the state.
    void computeTerminalCostDerivative(const double time, const std::vector<double>& state_vec, std::function<double(double)>& traj_curvature, std::function<double(double)>& traj_speed,
