...
class SingleShootingOCP final : public OptimalControlProblem
{
    ...
    // optimality_residual.
    void computeOptimalityResidual(const double time, const std::vector<double>& state_vec, const double* solution_vec, std::function<double(double)>& traj_curvature,
    ...
    void predictStateFromSolution(const double current_time, const std::vector<double>& current_state, const double* solution_vec, const double prediction_length,
