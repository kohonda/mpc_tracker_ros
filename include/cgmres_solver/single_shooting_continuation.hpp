...
class SingleShootingContinuation {
 public:
  ...
  //  zeta: A parameter for stabilization of the C/GMRES method. It may work
  //    well to set this parameters as the reciprocal of the sampling period.
  SingleShootingContinuation(const double T_f, const double alpha, const int N, const double initial_time,
                             const double finite_difference_increment, const double zeta);
  ...
  double computeErrorNorm(const double time, const std::vector<double>& state_vec, const double* solution_vec,
  ...
  // MatrixfreeGMRES.
  void bFunc(const double time, const std::vector<double>& state_vec, const double* current_solution_vec,
             std::function<double(double)>& traj_curvature, std::function<double(double)>& traj_speed,
  ...
  // MatrixfreeGMRES.
  void AxFunc(const double time, const std::vector<double>& state_vec, const double* current_solution_vec,
              std::function<double(double)>& traj_curvature, std::function<double(double)>& traj_speed,
