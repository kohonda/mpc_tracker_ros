...
class CGMRESInitializer {
 public:
  ...
  CGMRESInitializer(const double finite_difference_increment, const int kmax, const double newton_residual_tolerance,
  ...
  void computeInitialSolution(const double initial_time, const std::vector<double>& initial_state_vec,
  ...
  void getInitialLambda(const double initial_time, const std::vector<double>& initial_state_vec,
                        std::function<double(double)>& traj_curvature, std::function<double(double)>& traj_speed,
 ...
 private:
  ...
  MatrixFreeGMRES<NewtonGMRESForOCP<ZeroHorizonOCP>, const double, const std::vector<double>&, const double*,
