...
inline Eigen::Vector3d Pose::xyz() const { return Eigen::Vector3d(x, y, z); }

inline Eigen::Vector2d Pose::xy() const { return Eigen::Vector2d(x, y); }

inline Eigen::Vector3d Pose::rpy() const { return Eigen::Vector3d(roll, pitch, yaw); }

inline Eigen::Vector3d Pose::xyyaw() const { return Eigen::Vector3d(x, y, yaw); }
