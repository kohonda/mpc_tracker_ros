...
struct Twist {
  ...
  Twist(const double& x, const double& y, const double& z, const double& roll, const double& pitch, const double& yaw)
...
inline Eigen::Vector3d Twist::xyz() const { return Eigen::Vector3d(x, y, z); }

inline Eigen::Vector2d Twist::xy() const { return Eigen::Vector2d(x, y); }

inline Eigen::Vector3d Twist::rpy() const { return Eigen::Vector3d(roll, pitch, yaw); }

inline Eigen::Vector3d Twist::xyyaw() const { return Eigen::Vector3d(x, y, yaw); }
